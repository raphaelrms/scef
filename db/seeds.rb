...
PermissionRole.find_or_create_by_permission_id_and_role_id :permission_id => (Permission.find_or_create_by_action_and_subject_class :action => 'manage', :subject_class => 'all').id, :role_id => user.roles.first.id
