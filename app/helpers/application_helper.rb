...
def link_to_add_fields(name, f, association,classe = "")
  ...
  link_to_function((name + " <i class=\"glyphicon glyphicon-plus\"></i>").html_safe, "add_fields(this, '#{association}', '#{escape_javascript(fields)}')",:class => "btn btn-success", :remote => true)
end